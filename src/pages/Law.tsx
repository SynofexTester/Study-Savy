...
const notes = [
    ...
    {
        id: "law-3",
        title: "Criminal Law Case Briefs",
                ...
                <div className="container mx-auto px-4">
                    ...
                    >
                        ...
                        <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                            Essential case briefs, outlines, and notes for Contract, Criminal, and Constitutional Law.
                        </p>
                    </motion.div>
